...
class SensorGroup(base.InventoryObject,
    ...
    fields = {
        ...
        'unit_base_group': object_fields.StringField(nullable=True),
        'unit_modifier_group': object_fields.StringField(nullable=True),
